...
Tags: related, posts, community, network, plugin
Donate Link: http://www.blogglue.com/pricing/ 
Contributors: BlogGlue.com
Requires at least: 2.8.6
Tested up to: 3.3.1
Stable tag: 5.2

This plugin will add links at the bottom of every post to other similar posts.  The plugin also lets you pick other WP blogs as partners.
...
1. Click "Add New" button (top center of screen).

1. Search Term "BlogGlue Related Posts" (center of screen).

1. Click "Install Now" under "BlogGlue Related Posts Network Plugin" (first result).

1. Click "Activate Now" (center of screen).

1. Follow on screen setup instructions.
...
* On Our Website: [Contact Form](http://www.blogglue.com/contact/ "Contact BlogGlue For Support regarding BlogGlue Related Posts Network Plugin.")
* Using Twitter: [blogglue](http://www.twitter.com/blogglue "The Official BlogGlue Twitter page regarding BlogGlue Related Posts Network Plugin.")
* Via Email: [support@blogglue.com](mailto:support@blogglue.com "BlogGlue support email regarding BlogGlue Related Posts Network Plugin.")
...
[**Visit help for the BlogGlue Related Posts Network Plugin by BlogGlue.**](http://www.blogglue.com/help/ "BlogGlue help for the BlogGlue Related Posts Network Plugin.") Youre about to try something very cool, we hope you find some really cool partners to connect with from all over the world.

== Screenshots ==

1. Control all Aspects of BlogGlue Related Posts Network Plugin through a simple control panel within WordPress.
1. Esily manage community partners from email or the BlogGlue website. Pick your partners from a list.
1. Quickly see which partners are delivering visitors.  As you get more partners you get more visitors.
...
= 0.99 =
* Related links show up in RSS readers.
...
= 1.03 =
* If you were having install instructions please upgrade to this, token validation is improved.

= 1.04 =
* Added BlogGlue Profile Badge in the form of a widget, your theme must support widgets.
* Fixed issue with excerpts, code no longer shows on short posts
* Fixed attachment issue, posts no longer show on attachment pages.
* Fixed issue with CSS/JS in the RSS feeds.  Affects Facebook and some RSS readers.
...
= 4.8 =
* Warning, you may need to log out of WP and log back in, all settings will be saved.
* New control panel.
* Ability to toggle SEO Analyzer on and off in edit post/page panel.
* Improved auto installation.
